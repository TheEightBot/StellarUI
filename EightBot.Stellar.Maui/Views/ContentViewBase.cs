    ...
    where TViewModel : class
{
    ...
    protected ContentViewBase(bool delayBindingRegistrationUntilAttached = false)
    {
    ...
    protected override void OnPropertyChanged(string propertyName = null)
    {
        ...
        _viewManager.OnVisualElementPropertyChanged<ContentViewBase<TViewModel>, TViewModel>(this, ViewModelProperty.PropertyName, propertyName);
    }
